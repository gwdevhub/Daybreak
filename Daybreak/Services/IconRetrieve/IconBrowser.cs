...
public sealed class IconBrowser : IIconBrowser
{
    ...
    private const string FaultyBase64V2 = "";
    ...
    private async Task ServeRequest()
    {
        ...
        for (var i = 0; i < 5; i++)
        {
            ...
            if (potentialBase64 == FaultyBase64 ||
                ...
                potentialBase64 == FaultyBase64V2)
            {
