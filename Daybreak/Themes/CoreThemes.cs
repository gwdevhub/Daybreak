...
public static class CoreThemes
{
    ...
    public static readonly Theme Nightfall = new("Nightfall", ColorPalette.AccentColor.DarkGreen, "img/backdrops/nightfall.png", LightDarkMode.Dark);
    ...
    public static readonly Theme ShiningBlade = new("Shining Blade", ColorPalette.AccentColor.DarkGreen, "img/backdrops/shiningblade.png", LightDarkMode.Dark);
