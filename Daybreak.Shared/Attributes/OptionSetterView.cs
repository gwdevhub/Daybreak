...
/// The custom view must be registered in the <see cref="Shared.Services.Navigation.IViewManager"/>
/// </summary>
/// <typeparam name="T">Type of view. Has to be registered in the <see cref="Shared.Services.Navigation.IViewManager"./></typeparam>
